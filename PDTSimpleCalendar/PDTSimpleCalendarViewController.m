...
{
  [self setSelectedDate:[self dateForCellAtIndexPath:indexPath]
               animated:YES callDelegate:YES];
}
...
- (NSDate *)dateForCellAtIndexPath:(NSIndexPath *)indexPath
{
  ...
  NSDate *returnDate = [self.calendar dateByAddingComponents:dateComponents toDate:firstOfMonth options:0];
